                    ...
                    <div class="breadscrumb-contain breadscrumb-order">
                        <div class="order-box">
                            ...
                            <div class="order-contain">
                                ...
                                <h6>Transaction ID: {{ $order->code }}</h6>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    @foreach ($carts as $cart)
                                        <tr>
                                                    ...
                                                    <div class="product-detail">
                                                        <ul>
                                                            ...
                                                            <li class="text-content">Category:
                                                                {{ $cart->products->categorys->name }}</li>

                                                            <li class="text-content">Quantity: {{ $cart->quantity }}</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="price">
                                                ...
                                                <h6 class="theme-color">${{ $cart->products->price }}.00</h6>
                                            </td>
                                            ...
                                            <td class="subtotal">
                                                ...
                                                @foreach ($carts as $cart)
                                                    ...
                                                    @endphp
                                                @endforeach
                                                <h5>${{ $cart->quantity * $cart->products->price }}.00</h5>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <div class="col-lg-12 col-sm-6">
                            <div class="summery-box">
                                ...
                                <ul class="summery-contain">
                                    <li>
                                        <h4>Sub Total</h4>
                                        <h4 class="price">${{ $totalPrice }}.00</h4>
                                    </li>
                                ...
                                <form class="summery-total" action="{{ url('checkout/re_payment', []) }}" method="post">
                                    @csrf
                                    <input type="number" style="display: none" value="{{ $order->code }}"
                                        name="vnp_TxnRef">
