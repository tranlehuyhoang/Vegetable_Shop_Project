                                            ...
                                            <div class="order-box dashboard-bg-box">
                                                <div class="order-container">
                                                    ...
                                                    <div class="order-detail">
                                                        @if ($order->payment == 1)
                                                            <a href="{{ url('invoice/' . $order->code . '', []) }}">
                                                                <h4>#{{ $order->code }} <span class="success-bg">Đã thanh
                                                                        toán</span>
                                                                </h4>
                                                            </a>
                                                        @else
                                                            <a href="{{ url('order-success/' . $order->code . '', []) }}">
                                                                <h4>#{{ $order->code }} <span>Chưa thanh toán</span></h4>
                                                            </a>
                                                        @endif
                                                ...
                                                <div class="product-order-detail">
                                                    <a href="product-left-thumbnail.html" class="order-image">
                                                        <img src="{{ asset('assets_client/box.png') }}"
                                                            style="width: 200px" class="blur-up lazyload" alt="">
                                                    </a>
